...
namespace MatrimonialCapstoneApplication.Migrations
{
    ...
    [Migration("20240726040630_duplicate-member-remove")]
    partial class duplicatememberremove
    {
            ...
            modelBuilder.Entity("MatrimonialCapstoneApplication.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MatchId = 1,
                            FromProfileId = 1,
                            MatchDate = new DateTime(2024, 7, 26, 4, 6, 30, 406, DateTimeKind.Utc).AddTicks(4488),
