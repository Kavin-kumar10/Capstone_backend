...
namespace MatrimonialCapstoneApplication.Migrations
{
    ...
    [Migration("20240728052722_initial")]
            ...
            modelBuilder.Entity("MatrimonialCapstoneApplication.Models.DailyLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DailyLogId = 1,
                            CreditsCount = 5,
                            Date = new DateTime(2024, 7, 28, 10, 57, 22, 575, DateTimeKind.Local).AddTicks(9421),
                            MemberId = 2
                        });
                });
            ...
            modelBuilder.Entity("MatrimonialCapstoneApplication.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MatchId = 1,
                            FromProfileId = 1,
                            MatchDate = new DateTime(2024, 7, 28, 5, 27, 22, 575, DateTimeKind.Utc).AddTicks(9584),
