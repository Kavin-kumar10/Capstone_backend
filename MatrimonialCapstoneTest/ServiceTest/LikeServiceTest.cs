...
namespace MatrimonialCapstoneTest.ServiceTest
{
    public class LikeServiceTest
    {
        ...
        public void Setup()
        {
            ...
            _likeService = new LikeServices(_mockRepo.Object,_mockLikeRepository.Object);
        }

        //[Test]
        //public async Task CreateDuplicate_exception()
        //{
        //    var like = new Like { LikeId = 1, LikedById = 101, LikedId = 202, CreatedAt = DateTime.Now };
        //    var like2 = new Like { LikeId = 2, LikedById = 101, LikedId = 202, CreatedAt = DateTime.Now };

        //    awaa_mockRepo.Setup(repo => repo.Create(It.IsAny<Like>()))
        //        .ReturnsAsync((Like like) => {
        //            if (like.LikedId == 202 && like.LikedById == 101)
        //            {
        //                return null; // Simulate duplicate by returning null
        //            }
        //            return like;
        //        });
        ...
        //    Assert.ThrowsAsync<LikeDuplicateException>(async() => await _likeService.Create(like2));
